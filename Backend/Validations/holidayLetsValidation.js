...
const propertyValidationSchema = Joi.object({
    ...
    sizeUnit: Joi.string()
        ...
        .messages({
            ...
            "any.only":
                "Invalid size unit. Must be: sqft, sqm, kanal, or marla.",
        }),
    ...
    postalCode: Joi.string()
        .trim()
        // Assuming 5-digit postal code for Pakistan, adjust regex if necessary
        .pattern(/^\d{5}$/)
        .optional()
        .messages({
            "string.base": "Postal code must be a string.",
            "string.pattern.base":
                "Postal code must be 5 digits (e.g., 12345).",
        }),
    ...
    accessDescription: Joi.string()
        ...
        .messages({
            ...
            "string.max":
                "Access description cannot exceed {#limit} characters.",
        }),
    hostInteraction: Joi.string()
        .max(500)
        .optional()
        .messages({
