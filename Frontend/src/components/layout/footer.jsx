            ...
            <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex mt-4">
                            <input
                                ...
                                className="px-4 py-3 rounded-l-lg w-full bg-gray-800 border-0 focus:ring-2 focus:ring-red-500"
                            />
                            <button className="bg-red-600 text-white px-4 py-3 rounded-r-lg hover:bg-red-700 transition-colors">
                ...
                <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <p>&copy; 2025 Marbo Global. All rights reserved.</p>
                    </div>
