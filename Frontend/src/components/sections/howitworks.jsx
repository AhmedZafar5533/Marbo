...
const steps = [
  {
    ...
    description:
      "Our platform unites families and local communities with highly skilled professionals offering a diverse range of tailored service solutions.",
    icon: <FaHandshake />,
    category: "services",
  ...
  },
  {
    ...
    description:
      "Join our community—whether you're a trusted service provider or a client seeking reliable solutions—through our quick and simple sign-up process.",
    icon: <FaUserPlus />,
    category: "services",
    color: colors.primary,
  },
  {
    ...
    description:
      "Boost confidence and trust with a streamlined verification process and secure document uploads for every provider.",
    icon: <FaUserCheck />,
    category: "services",
    color: colors.primary,
  },
  {
    ...
    description:
      "Select the service plan that best fits your needs, unlocking enhanced features and deeper connections within the community.",
    icon: <FaStore />,
    category: "services",
    color: colors.primary,
  },
  {
    title: "Browse & Engage",
    description:
      "Explore a wide array of reliable services and engage directly with professionals committed to community growth.",
    icon: <FaShoppingCart />,
    category: "services",
    color: colors.primary,
  },
  {
    ...
    description:
      "Experience secure and efficient payment processing, designed to support smooth transactions in our trusted network.",
    icon: <FaCreditCard />,
    category: "services",
    color: colors.primary,
  },
