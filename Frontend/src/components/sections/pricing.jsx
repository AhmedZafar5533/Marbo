...
const VendorLandingSection = () => {
  return (
    <div className="lg:flex lg:w-full lg:justify-center mt-1 lg:mt-20 lg:mb-20">
      <div className="flex flex-col md:flex-row min-h-[600px] overflow-hidden rounded-md font-inter lg:shadow-md lg:w-[95%]">
        ...
        <div className="w-full md:w-1/2 bg-[#1c3144] text-[#FFFFFF] p-12 md:p-12 sm:p-6 flex items-center">
          <div className="max-w-md mx-auto">
            <span className="block uppercase tracking-wider text-md font-semibold mb-4 text-red-600">
              For Vendors
            </span>
            ...
            <p className="text-lg text-[#FFFFFF] mb-8 leading-relaxed opacity-80">
              Unlock flexible pricing plans designed to scale your business with
              zero overhead and maximum potential.
            </p>
            ...
            <div className="mb-6">
              <div className="inline-flex items-center bg-gradient-to-r from-[#FD1A03] to-[#ec5f4f] text-[#FFFFFF] rounded-full py-2 px-6 transition duration-300 ease-in-out shadow-lg hover:-translate-y-1 hover:shadow-xl">
