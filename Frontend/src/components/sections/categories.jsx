...
const CategoriesAndServices = () => {
  ...
  return (
    <div className="relative min-h-screen  overflow-hidden">
      ...
      {/* Services Section */}
      <section className="z-10 py-10 px-4 bg-white bg-gradient-to-t  from-[#FCE6A6] to-[#FFFFFF] text-[#646965]">
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="relative p-8 text-center">
                  ...
                  {service.badge && (
                    <span className="absolute top-4 right-4 px-3 py-1 text-xs font-semibold text-white bg-gradient-to-r from-[#FD1A03] to-[#ec5f4f] rounded-full uppercase">
                      {service.badge}
                    </span>
                  )}
      ...
      <section className="relative z-10  px-4 bg-gradient-to-b from-[#FCE6A6] to-[#FFFFFF] text-[#646965]">
                    ...
                    >
                      <div className="bg-white/60 backdrop-blur-lg rounded-2xl overflow-hidden shadow-2xl border border-[#646965]/20 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        ...
                        <div className="p-6 text-center">
                          ...
                          <button className="group relative inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-[#FD1A03] to-[#ec5f4f] text-white rounded-full font-semibold text-sm hover:bg-[#FD1A03]/80 transition-all">
                            View Services
