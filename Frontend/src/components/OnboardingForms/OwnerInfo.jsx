...
const OwnerInformation = ({ nextStep, prevStep, currentStep, totalSteps }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        await sendOwnerDetails({
            ...
            ownerPhoto: formData.ownerPhotoBase64 || formData.ownerPhoto,
            ownerDocumentPhoto: formData.ownerDocumentPhotoBase64 || formData.ownerDocumentPhoto,
        });
    ...
    const renderFileInput = (label, name) => (
        <div className="space-y-2">
            ...
            {(formData[`${name}Base64`] || (formData[name] && typeof formData[name] === 'string')) && (
                <div className="mt-2">
                    <img
                        src={formData[`${name}Base64`] || formData[name]}
                        alt="Preview"
