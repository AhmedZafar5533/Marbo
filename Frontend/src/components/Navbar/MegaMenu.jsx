...
const MegaMenu = ({ hoverItem, menuItems, handleMouseLeave, timeoutRef, onOptionClick }) => {
    return (
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                                {menuItems[hoverItem].submenu.map((subItem, subIndex) => (
                                    <Link
                                        ...
                                        className="group flex flex-col p-4 rounded-xl hover:bg-red-50 transition-colors duration-300 border border-transparent hover:border-red-100"
                                    >
                                        <div className="mb-2">
                                            <div className="font-medium text-gray-800 group-hover:text-red-700 transition-colors duration-300">
                                                {subItem.name}
                                            </div>
                                        </div>
