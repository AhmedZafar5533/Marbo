        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="md:w-2/3 text-center md:text-left">
              <h3 className="text-xl font-bold text-slate-800 mb-2">Need a custom service?</h3>
              <p className="text-slate-600 mb-4">We're here to help you find the perfect solution for your needs.</p>
