...
const ProductUploadForm = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.quantity) {
            newErrors.price = 'Quantity is required';
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Add your product to our marketplace and reach thousands of potential customers
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="p-8 sm:p-10">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 ${errors.productName ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                        }`}
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 ${errors.category ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                        }`}
                                >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        step="0.01"
                                        min="0"
                                        className={`w-full pl-8 pr-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 ${errors.price ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                            }`}
                                        placeholder="0.00"
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    min="0"
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-200 ${errors.quantity ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'
                                        }`}
                        ...
                        <div className="mb-10">
                            ...
                            <textarea
                                ...
                                placeholder="Describe your product in detail. Include materials, dimensions, usage instructions, and what makes it special..."
                            />
                            {errors.description && (
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-100">
                                <div className="flex gap-3 mb-6">
                                    <input
                                        ...
                                        placeholder="e.g., 30-hour battery life, noise cancellation..."
                                    />
                                    <button
                                        type="button"
                                        onClick={addFeature}
                                ...
                                {formData.features.length > 0 ? (
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-sm text-gray-400 mt-1">Add key features to highlight what makes your product special</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="mb-10">
                            ...
                            <div
                                className={`relative border-2 border-dashed rounded-2xl p-10 text-center transition-all duration-300 ${dragActive
                                    ...
                                    } ${formData.images.length >= 4 ? 'opacity-50 cursor-not-allowed' : 'hover:border-blue-400 hover:bg-blue-50'}`}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold text-gray-800 mb-2">
                                    {dragActive ? 'Drop your images here' : 'Upload Product Photos'}
                                </h3>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-end pt-8 border-t border-gray-100">
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className={`px-10 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-2xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg flex items-center justify-center ${isLoading ? 'opacity-75 cursor-not-allowed' : 'hover:shadow-xl'
                                    }`}
                            >
                                {isLoading ? (
                                    <>
