...
const VendorDashboardServicesSection = () => {
  ...
  useEffect(() => {
    ...
    if (user.onboardingDone === "pending") navigate("/vendor/wait/review");
  }, [user, navigate]);
  ...
  const handleEnableEdit = (service) => {
    ...
    setEditFormData({
      ...service,
      image: { ...(service.image.url ? service.image : { url: "" }) },
    });
  };
  ...
  const handleSaveEdit = () => {
    const original = services.find(
      (service) => service._id === editFormData._id
    );
    const updatedFields = {};
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="Mortgage Services">Mortgage Services</option>
                  <option value="Payments & Utilities">
                    Payments & Utilities
                  </option>
                  <option value="Professional Services">
                    Professional Services
                  </option>
                  <option value="Properties for Sale">
                    Properties for Sale
                  </option>
                  ...
                  <option value="Rent Collection">Rent Collection</option>
                  <option value="Rental Properties">Rental Properties</option>
                  <option value="School Fee Payments">
                    School Fee Payments
                  </option>
                  <option value="Tech Supplies">Tech Supplies</option>
                  ...
                  <option value="Utility Payments">Utility Payments</option>
                  <option value="Water Bill Payments">
                    Water Bill Payments
                  </option>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-600">
            Manage and organize all your services in one place
          </p>
        </div>
        ...
        {services.length === 0 && (
          <div className="bg-white rounded-2xl shadow-md p-8 text-center">
            ...
            <p className="mt-2 text-gray-500">
              You haven't added any services yet. Click the button above to add
              your first service.
            </p>
            <button
              onClick={() => setShowUploadModal(true)}
        ...
        {showServiceDetails && (
          <ServiceDetailModal service={showServiceDetails} />
        )}
        {editMode && (
          <EditServiceModal
