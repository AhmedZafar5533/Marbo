...
const ClothingUploadForm = () => {
    ...
    const { addClothes } = useClothingStore()
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const success = await addClothes(submissionData);
            if (success) {
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="text-center">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Showcase your fashion pieces and reach style-conscious customers worldwide
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                    ...
                    <div className="p-8 sm:p-10">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
                            ...
                            <div className="lg:col-span-2">
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-100 focus:border-pink-500 transition-all duration-200 ${errors.productName ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                                    placeholder="e.g., Vintage Denim Jacket, Summer Floral Dress"
                                />
                                {errors.productName && (
                                    <p className="mt-2 text-sm text-red-600 font-medium">{errors.productName}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-100 focus:border-pink-500 transition-all duration-200 ${errors.category ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                                >
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={handleInputChange}
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-100 focus:border-pink-500 transition-all duration-200 ${errors.gender ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                                >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        step="0.01"
                                        min="0"
                                        className={`w-full pl-8 pr-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-100 focus:border-pink-500 transition-all duration-200 ${errors.price ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                                        placeholder="0.00"
                                    />
                                </div>
                                {errors.price && (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    min="0"
                                    className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-100 focus:border-pink-500 transition-all duration-200 ${errors.quantity ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                        ...
                        <div className="mb-10">
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                rows={6}
                                className={`w-full px-4 py-4 border-2 rounded-2xl focus:ring-4 focus:ring-pink-100 focus:border-pink-500 transition-all duration-200 resize-none ${errors.description ? 'border-red-300 bg-red-50' : 'border-gray-200 hover:border-gray-300'}`}
                        ...
                        <div className="mb-10">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-100">
                                ...
                                {formData.category && commonSizes[formData.category] && (
                                    <div className="mb-4">
                                        <p className="text-sm text-gray-600 font-semibold mb-3">Quick Add:</p>
                                ...
                                <div className="flex gap-3 mb-6">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => addItem('sizes', currentSize, currentSize, setCurrentSize)}
                                ...
                                {formData.sizes.length > 0 ? (
                                    <div className="flex flex-wrap gap-2">
                                        {formData.sizes.map((size, index) => (
                                            ...
                                            >
                                                <span className="text-gray-700 font-medium mr-2">{size}</span>
                                                <button
                                                    type="button"
                                    ...
                                    <div className="text-center py-6">
                                        <p className="text-gray-500 font-medium">No sizes added yet</p>
                                        <p className="text-sm text-gray-400 mt-1">Add available sizes for this item</p>
                                    </div>
                                )}
                                {errors.sizes && (
                                    <p className="mt-3 text-sm text-red-600 font-medium">{errors.sizes}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="mb-10">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-100">
                                <div className="flex gap-3 mb-6">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => addItem('colors', currentColor, currentColor, setCurrentColor)}
                                ...
                                {formData.colors.length > 0 ? (
                                    <div className="flex flex-wrap gap-2">
                                        {formData.colors.map((color, index) => (
                                            <div
                                                ...
                                                className="bg-white px-4 py-2 rounded-xl border border-gray-200 flex items-center group hover:border-pink-200 hover:bg-pink-50 transition-all duration-200"
                                            >
                                                <span className="text-gray-700 font-medium mr-2">{color}</span>
                                                <button
                                                    type="button"
                                    ...
                                    <div className="text-center py-6">
                                        ...
                                        <p className="text-sm text-gray-400 mt-1">Add available colors for this item</p>
                                    </div>
                                )}
                                {errors.colors && (
                                    <p className="mt-3 text-sm text-red-600 font-medium">{errors.colors}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="mb-10">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border-2 border-gray-100">
                                <div className="flex gap-3 mb-6">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => addItem('features', currentFeature, currentFeature, setCurrentFeature)}
                                ...
                                {formData.features.length > 0 ? (
                                    <div className="flex flex-wrap gap-2">
                                        {formData.features.map((feature, index) => (
                                            <div
                                                ...
                                                className="bg-white px-4 py-2 rounded-xl border border-gray-200 flex items-center group hover:border-pink-200 hover:bg-pink-50 transition-all duration-200"
                                            >
                                                <span className="text-gray-700 font-medium mr-2">{feature}</span>
                                                <button
                                                    type="button"
                                    ...
                                    <div className="text-center py-6">
                                        ...
                                        <p className="text-sm text-gray-400 mt-1">Add features or benefits</p>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="p-8 sm:p-10 bg-gray-50">
                        ...
                        <div className="mb-8">
                            <div
                                className={`relative border-2 border-dashed rounded-3xl p-8 text-center transition-all duration-300 ${dragActive
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="text-gray-600 mb-6 max-w-md">
                                        Drag and drop your images here, or click to browse. Upload up to 4 high-quality images.
                                    </p>
                    ...
                    <div className="p-8 sm:p-10 bg-white border-t border-gray-100">
                        <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
                            <div className="text-sm text-gray-600">
                                <p className="font-medium">Ready to upload your clothing item?</p>
