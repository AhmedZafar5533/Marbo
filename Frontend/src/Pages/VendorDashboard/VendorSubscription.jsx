                    ...
                    {hasSubscription && subscriptionData ? (
                        ...
                        <>
                            ...
                            <div className="p-8 sm:p-12 text-center">
                                ...
                                <h2 className="text-3xl font-bold text-gray-800 sm:text-4xl">You're not subscribed</h2>
                                <p className="mt-4 text-gray-600 max-w-md mx-auto">
                                    You currently don’t have an active subscription. Subscribe now to unlock features tailored for your business.
                                </p>

                                <div className="mt-8">
                                    <button
                                        onClick={() => navigate("/pricing")}
                                        className="px-6 py-3 bg-indigo-700 text-white font-medium rounded-xl hover:bg-indigo-800 transition duration-200 shadow-md"
                                    >
                                        Subscribe Now
                                    </button>
                                </div>
