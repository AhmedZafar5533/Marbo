...
const DomesticStaffingDashboard = () => {
    ...
    const { getDashboardData, dashboardData, editDomesticStaffing, loading, deleteDomesticStaffing } = useDomesticStaffingStore()
...
export default DomesticStaffingDashboard;