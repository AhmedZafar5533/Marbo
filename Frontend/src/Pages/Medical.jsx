...
const MedicalService = () => {
  ...
  const handleAddToCart = async () => {
    if (!selectedService || !selectedSchedule) {
      alert("Please select a service and schedule first.");
      return;
    }
    ...
    try {
      const selectedServiceData = doctors.find(
      ...
      const cartItem = {
        ...
        name: `${selectedServiceData.type} - ${selectedSchedule}`,
        imageUrl: galleryImages[0].url,
        quantity: 1,
        subDetails: {
          doctorType: selectedServiceData.type,
          ...
          includedItems: selectedScheduleData.includedItems,
        },
      };

      // Call your store's addToCart function
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-red-100 flex items-center justify-center p-4">
        <div className="bg-white shadow-xl rounded-2xl p-8 max-w-md text-center animate-fade-in">
          ...
          <p className="text-slate-500">
            We couldn't find any medical services at the moment. Please check
            back later.
          </p>
        </div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              {serviceData?.description ||
                "Professional medical care services with certified doctors and specialists"}
            </p>
          </div>
        </section>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-slate-800 mb-2">
                    {serviceData?.vendorName || "Medical Center"}
                  </h2>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h3 className="text-4xl font-bold text-slate-800 mb-4">
              Step 1: Choose Your Medical Service
            </h3>
                ...
                <div className="rounded-2xl p-6 h-full">
                  <div
                    className={`mb-4 group-hover:scale-110 transition-transform duration-300 ${
                      selectedService === doctor._id ? "scale-110" : ""
                    }`}
                  >
                    <div
                  ...
                  >
                    Starting from $
                    {Math.min(...doctor.schedule.map((s) => s.rate))}/session
                  </div>
                  {selectedService === doctor._id && (
        ...
        {selectedService && selectedSchedule && (
          <section className="mb-16">
            ...
            <div className="bg-white/90 backdrop-blur-xl shadow-2xl rounded-3xl p-8 border border-white/50 max-w-4xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <input
                    ...
                    min={getMinDate()}
                    max={getMaxDate()}
                    className="w-full p-4 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 text-lg"
                  />
                </div>
                      ...
                      <button
                        ...
                        className={`p-3 rounded-lg border-2 font-medium transition-all duration-300 ${
                          selectedTime === time
                            ...
                            : "bg-white text-slate-700 border-gray-300 hover:border-red-300 hover:bg-red-50"
                        }`}
                      >
                        {time}
                      </button>
                ...
                <div className="flex flex-col md:flex-row items-center justify-center gap-8">
                  ...
                  <div className="text-left">
                    <div className="mb-2">
                      ...
                      {doctors.find((s) => s._id === selectedService)?.type}
                    </div>
                    <div className="mb-2">
                    ...
                    <div className="mb-2">
                      <span className="font-semibold">Sessions:</span>{" "}
                      {
                        doctors
                          .find((s) => s._id === selectedService)
                          ?.schedule.find(
                            (sch) => sch.name === selectedSchedule
                          )?.days
                      }{" "}
                      per week
                    </div>
                    <div className="mb-4">
                      <span className="font-semibold">First Appointment:</span>{" "}
                    ...
                    <button
                      ...
                      className="bg-white text-red-600 px-8 py-3 rounded-xl font-bold hover:bg-red-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
