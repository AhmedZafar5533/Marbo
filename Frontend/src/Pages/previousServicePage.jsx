  ...
  useEffect(() => {
    if (filteredServices.length > 0) {
      ...
      filteredServices.forEach((category) => {
        initialOpenState[category.name] = true;
      });
            ...
            {displayServices.map((category, categoryIndex) => (
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    animate={{
                      rotate: openCategories[category.name] ? 0 : -90,
                    }}
...
const ProductList = ({ products }) => {
  ...
  return (
    <div className="py-16 lg:py-24 bg-gradient-to-br from-slate-50 via-white to-slate-50">
      <div className="w-[90%] max-w-7xl mx-auto lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {products.map((product) => (
            <div
              ...
              className="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 overflow-hidden border border-slate-200 hover:border-slate-300 flex flex-col h-full"
            >
              <div className="relative overflow-hidden h-48">
                ...
                {product.type && (
                  <div className="absolute top-3 left-3 bg-red-600/95 backdrop-blur-sm text-white px-3 py-1 rounded-lg text-xs font-semibold">
                    {product.type}
                  </div>
                )}
                ...
                {product.price && (
                  <div className="absolute bottom-3 left-3 bg-slate-900/90 backdrop-blur-sm rounded-lg px-3 py-1.5">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                >
                  <button className="w-full bg-gradient-to-r from-red-600 to-rose-600 text-white py-3.5 rounded-xl font-semibold hover:from-red-700 hover:to-rose-700 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5">
                    View Details
                  </button>
                </Link>
              </div>
...
const ServiceMarketplace = () => {
  ...
  const { fetchDisplayProducts, displayProducts } = useProductStore();

  useEffect(() => {
    fetchDisplayProducts();
  }, [fetchDisplayProducts]);

  // Mock data for the ProductList component
  const roomsData = [
    {
      _id: "1",
      ...
      features: ["Ocean View", "Balcony", "Free Wi-Fi", "Mini Bar"],
    },
    {
      _id: "2",
      ...
      features: ["City View", "Free Wi-Fi", "Coffee Maker"],
    },
    {
      _id: "3",
      ...
      images: [
        {
          imageUrl:
            "https://images.unsplash.com/photo-1578683010236-d716f9a3f458?w=800&auto=format&fit=crop&q=80",
        },
      ],
      features: ["Garden View", "Free Wi-Fi", "Pet-friendly"],
    },
  ];
  ...
  return (
    <>
      <ServicesCarousel frontEndServices={frontEndServices} />
      {/* <ServicesSection frontEndServices={frontEndServices} /> */}
