        ...
        <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 min-h-screen py-6">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                ...
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-bold text-indigo-700 mb-2">Your Profile</h1>
                    <p className="text-indigo-600">Manage your account information and security settings</p>
                </div>
                            ...
                            <div className="relative z-10">
                                <div className="relative group">
                                    <div className="h-48 w-48 rounded-full overflow-hidden border-4 border-white shadow-2xl ring-8 ring-indigo-300 ring-opacity-50 transform transition-all duration-300 hover:scale-105">
                                        <img
                                            src={previewUrl || "https://www.gravatar.com/avatar/?d=mp&s=400"}
                                            alt="Profile"
                                            className="h-full w-full object-cover"
                                        />
                                    </div>
                                    <label htmlFor="profile-upload" className="absolute bottom-3 right-3 bg-white hover:bg-gray-100 text-indigo-600 p-3 rounded-full cursor-pointer shadow-lg transition-all transform hover:scale-110">
                                ...
                                <div className="mt-10 w-full">
                                    <div className="bg-indigo-700 bg-opacity-50 rounded-2xl p-6 backdrop-blur-sm">
                                        ...
                                        <div className="mt-4 pt-4 border-t border-indigo-500 border-opacity-50">
                                            <p className="text-sm text-indigo-200">Last login: Today at 9:45 AM</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:w-2/3 p-8 lg:p-12">
                            ...
                            <div className="space-y-6">
                                <div className="bg-indigo-50 rounded-xl p-6 transition-all duration-300 hover:shadow-md">
                                    <label className="block text-sm font-medium text-indigo-800 mb-2">Username</label>
                                ...
                                <div className="bg-indigo-50 rounded-xl p-6 transition-all duration-300 hover:shadow-md">
                                    <label className="block text-sm font-medium text-indigo-800 mb-2">Email Address</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                ...
                                <div className="bg-indigo-50 rounded-xl p-6 transition-all duration-300 hover:shadow-md">
                                    <label className="block text-sm font-medium text-indigo-800 mb-2">Account Created</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                ...
                                <div className="mt-10 pt-6 border-t border-indigo-100">
                                    ...
                                    >
                                        <div className="bg-indigo-50 rounded-2xl p-8 shadow-inner">
                                            ...
                                            <div className="space-y-6">
                                                <div>
                                                    <label className="block text-sm font-medium text-indigo-800 mb-2">Current Password</label>
                                                    <div className="relative">
                                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                ...
                                                <div>
                                                    <label className="block text-sm font-medium text-indigo-800 mb-2">New Password</label>
                                                    <div className="relative">
                                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                    ...
                                                    {passwordError && (
                                                        <p className="mt-2 text-sm text-red-600 bg-red-50 p-2 rounded-lg">{passwordError}</p>
                                                    )}
                                                </div>

                                                <div>
                                                    <label className="block text-sm font-medium text-indigo-800 mb-2">Confirm New Password</label>
                                                    <div className="relative">
                                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                    ...
                                                    {passwords.confirm && passwords.new !== passwords.confirm && (
                                                        <p className="mt-2 text-sm text-red-600 bg-red-50 p-2 rounded-lg">Passwords do not match.</p>
                                                    )}
                                                </div>
                ...
                <div className="mt-12 text-center text-indigo-600 text-sm">
                    <p>Need help? Contact <a href="#" className="underline hover:text-indigo-800">Support</a></p>
                </div>
            </div>
        </div>
    );
