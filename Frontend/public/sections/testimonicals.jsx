      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12">
            ...
            <div className="relative">
              ...
              <div className="flex justify-center mt-6 gap-4">
                <button
                  ...
                  className="w-12 h-12 rounded-full bg-[#FD1A03] text-white flex items-center justify-center shadow-md hover:bg-[#FD1A03]/80 transition-colors focus:outline-none focus:ring-2 focus:ring-[#FD1A03]/40 focus:ring-offset-2 disabled:opacity-50"
                >
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <a to="/signup">
              <button className="mt-8 px-6 py-3 bg-[#FD1A03] text-white font-medium rounded-lg shadow-md hover:bg-[#FD1A03]/80 transition-colors focus:outline-none focus:ring-2 focus:ring-[#FD1A03]/50 focus:ring-offset-2">
                Join us Now
              </button>
            </a>
          </div>
